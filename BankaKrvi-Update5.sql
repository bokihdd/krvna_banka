...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2022 at 08:20 PM
...
--
ALTER TABLE `donacija`
  ADD CONSTRAINT `donacija_ibfk_1` FOREIGN KEY (`idPacijenta`) REFERENCES `pacijent` (`idPacijenta`),
  ADD CONSTRAINT `donacija_ibfk_2` FOREIGN KEY (`idKrvneGrupe`) REFERENCES `krvne_grupe` (`idKrvneGrupe`);
